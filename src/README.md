...
python -m src.infer_track --source "C:\Users\admin\Downloads\Робозон\conveyor_seg\video\test1.mp4" --show --save-jsonl picks.jsonl
```
```python -m src.infer_track --source "C:\Users\admin\Downloads\Робозон\conveyor_seg\video\test1.mp4" --show --save-jsonl picks.jsonl --save-video "C:\Users\admin\Downloads\Робозон\conveyor_seg\result_video.mp4"```
